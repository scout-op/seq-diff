...
class NusOrederedBzCenterLine(object):
    def __init__(self, centerlines, grid_conf, bz_grid_conf,cam_intrinsic):
    ...
    def construct_nodes_adj_raw(self):
        ...
        '''
        self.all_nodes_raw = []
        self.adj_raw = np.zeros((2 * len(self.centerlines), 2 * len(self.centerlines)), dtype=int)
    ...
    def nodes_merge(self):
        ...
        nodes_raw_nodes_map = np.array(nodes_raw_nodes_map, dtype=int)
        ...
        nodes_raw_nodes_index_map = np.array(nodes_raw_nodes_index_map, dtype=int)
        ...
        self.adj = np.zeros((len(self.all_nodes), len(self.all_nodes)), dtype=int)
