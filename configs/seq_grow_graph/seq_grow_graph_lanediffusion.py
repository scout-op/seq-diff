...
# load_from = "/mnt/tf-mdriver-jfs/exps/lixiangjie/roadnet/data_copy/lane2/work_dirs/seq_grow_graph_lanediffusion_s1_v4/epoch_26.pth"
...
train_dataloader = dict(
    batch_size=32,  # Reduced from 18 due to LaneDiffusion memory usage
)
...
# Work directory
work_dir = '/mnt/tf-mdriver-jfs/exps/lixiangjie/roadnet/data_copy/lane2/work_dirs/seq_grow_graph_lanediffusion_s3_v4'
