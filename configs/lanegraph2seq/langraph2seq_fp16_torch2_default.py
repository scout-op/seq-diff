...
vis_dir="default_aaai"
# resume = True


data_root = './data/nuscenes/backup_part/'
...
train_pipeline = [
    ...
    dict(type='Pack3DDetInputs', 
         ...
         meta_keys=('filename', 'ori_shape', 'img_shape', 'lidar2img', 'intrinsics', 'extrinsics',
                'pad_shape', 'scale_factor', 'flip', 'box_mode_3d', 'box_type_3d','token',
...
test_pipeline = [
    ...
    dict(type='Pack3DDetInputs', keys=['img'], 
         meta_keys=('filename', 'ori_shape', 'img_shape', 'lidar2img', 'intrinsics', 'extrinsics','token',
...
checkpoint_config = dict(interval=1, max_keep_ckpts=10) #没有生效
