...
class SwinTransformerUNet(nn.Module):
    ...
    def __init__(
        ...
        # Stronger conditioning: normalize condition and concatenate before projection
        self.cond_norm = nn.InstanceNorm2d(in_channels, affine=True)
        self.input_proj = nn.Conv2d(in_channels * 2, embed_dim, kernel_size=1)
    ...
    def forward(self, x, x_cond, t):
        ...
        # Normalize condition and concatenate with noisy input
        x_cond = self.cond_norm(x_cond)
