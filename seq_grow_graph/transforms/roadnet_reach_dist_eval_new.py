...
def eval_landmark_and_reach(reach_thresholds,landmark_thresholds,sample_length,num_proc,max_dpt, val_pkl,
    ...
    print_log("=" * linewidth, logger=logger)
    return landmark_precision, landmark_recall, landmark_f_score, reach_precision, reach_recall, reach_f_score
...
def BzRoadnetReachDistEvalNew(
    ...
    res = dict()
    landmark_precision, landmark_recall, landmark_f_score, reach_precision, reach_recall, reach_f_score = eval_landmark_and_reach(
        ...
        dx,
        bz_pc_range,
        bz_dx,beta,logger,EvalSeq2Graph,is_junction_only=False)
