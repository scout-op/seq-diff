...
class ARLanegraph2seqHead(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        super(ARLanegraph2seqHead, self).__init__(
        ...
        self.loss_seq = MODELS.build(loss_seq)
    ...
    def forward(self, mlvl_feats, input_seqs, img_metas):
        ...
        if self.training:
            ...
            while i<self.max_iteration:
                ...
                values.append(value)
                contains_572 = (input_seqs == 572).any(dim=1)
                all_rows_have_572 = contains_572.all()
                i+=1
                if all_rows_have_572:
                    break
            
            values = torch.cat(values, dim=-1)
            return input_seqs, value
    ...
    def loss_by_feat(self,
        ...
        """
        pred_seq = preds_dicts['pred_seq']
        loss = self.loss_by_feat_single(
            pred_seq,
            gt_seq,)
